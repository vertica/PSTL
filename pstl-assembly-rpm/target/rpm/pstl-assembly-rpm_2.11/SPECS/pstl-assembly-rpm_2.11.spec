...
autoreq: yes
BuildArch: noarch
BuildRoot: /opt/mount1/softwares/pstl_github_vertica/clone/PSTL/pstl-assembly-rpm/target/rpm/pstl-assembly-rpm_2.11/buildroot
...
if [ -d $RPM_BUILD_ROOT ];
then
  mv /opt/mount1/softwares/pstl_github_vertica/clone/PSTL/pstl-assembly-rpm/target/rpm/pstl-assembly-rpm_2.11/tmp-buildroot/* $RPM_BUILD_ROOT
else
  mv /opt/mount1/softwares/pstl_github_vertica/clone/PSTL/pstl-assembly-rpm/target/rpm/pstl-assembly-rpm_2.11/tmp-buildroot $RPM_BUILD_ROOT
fi
...
%attr(644,root,root)  "/usr/share/pstl/lib/antlr4-runtime-4.7.jar"
...
%attr(644,root,root)  "/usr/share/pstl/lib/jinjava-2.4.6.jar"
%attr(644,root,root)  "/usr/share/pstl/lib/guava-22.0.jar"
%attr(644,root,root)  "/usr/share/pstl/lib/error_prone_annotations-2.0.18.jar"
%attr(644,root,root)  "/usr/share/pstl/lib/j2objc-annotations-1.1.jar"
%attr(644,root,root)  "/usr/share/pstl/lib/animal-sniffer-annotations-1.14.jar"
%attr(644,root,root)  "/usr/share/pstl/lib/javassist-3.22.0-GA.jar"
%attr(644,root,root)  "/usr/share/pstl/lib/jsoup-1.10.3.jar"
%attr(644,root,root)  "/usr/share/pstl/lib/commons-lang3-3.4.jar"
%attr(644,root,root)  "/usr/share/pstl/lib/annotations-3.0.1.jar"
%attr(644,root,root)  "/usr/share/pstl/lib/jackson-databind-2.7.9.1.jar"
%attr(644,root,root)  "/usr/share/pstl/lib/jackson-annotations-2.7.0.jar"
%attr(644,root,root)  "/usr/share/pstl/lib/jackson-core-2.7.9.jar"
