...
import org.apache.spark.sql.catalyst.expressions.{Expression, ExpressionDescription, ExpressionInfo, Generator, GeneratorOuter, RuntimeReplaceable}

object FunctionRegistryPrivateMethods {
  /** See usage above. */
...
//          df.since())
  ...
  def expressionGeneratorOuter[T <: Generator : ClassTag](name: String)
