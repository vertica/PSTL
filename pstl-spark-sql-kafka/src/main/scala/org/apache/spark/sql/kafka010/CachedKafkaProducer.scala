...
private[sql] object CachedKafkaProducer extends Logging {
   ...
   */
  private[sql] def getOrCreate(kafkaParams: ju.Map[String, Object]): Producer = {
  ...
  private[sql] def close(kafkaParams: ju.Map[String, Object]): Unit = {
